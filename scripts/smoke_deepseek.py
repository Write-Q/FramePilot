...
if not os.getenv('SMOKE_DATABASE_URL'):
    raise SystemExit('请设置独立 SMOKE_DATABASE_URL 并先初始化该数据库。')

with StoryService(os.environ['SMOKE_DATABASE_URL'], DeepSeekProvider(), max_calls=2) as service:
